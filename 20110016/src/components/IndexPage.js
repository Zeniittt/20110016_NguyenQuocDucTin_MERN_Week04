...
function PostCard({ post, onDeletePost }) {
    return (
        <Card
            ...
            <CardMedia
                sx={{ height: 240 }}
                image='https://images.pexels.com/photos/1661179/pexels-photo-1661179.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1&fbclid=IwAR3eO_l__-DpCHVllGwY3CKxyK74-I7MCJ19U5WOXGNIPBML0B6lu8HamiE'
                title={post.title}
            />
            <CardContent>
